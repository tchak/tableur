      ...
      <main className="container mx-auto flex flex-1 flex-col items-center justify-center overflow-hidden px-8">
        <section className="z-20 flex flex-col items-center justify-center gap-[18px] sm:gap-6">
          ...
          <p className="text-default-500 text-center leading-7 font-normal sm:w-[466px] sm:text-[18px]">
            Eiusmod ullamco nisi proident irure consequat Lorem minim et amet
            ipsum pariatur nostrud exercitation. Cupidatat nulla dolor sunt ut
            pariatur ex ex deserunt ex id dolore. Sint do est pariatur sint
            veniam.
          </p>
